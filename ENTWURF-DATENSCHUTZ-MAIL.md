...
Stand: 10. August 2026. Gehört zu den offenen Punkten aus
`docs/archiv/UEBERGABE-OFFEN.md`, Abschnitt 3.1.
...
Resend den Versand nicht schafft (steht so in `docs/archiv/UEBERGABE-OFFEN.md`, Abschnitt 4).
