...
const TEXTE = {
  ...
  pt: { betreff: (n) => `MovieMatch: ${n === 1 ? 'um título da sua watchlist já está disponível' : n + ' títulos da sua watchlist já estão disponíveis'}`,
        stream: 'Novidades nos seus serviços de streaming:', kino: 'Agora no cinema:',
