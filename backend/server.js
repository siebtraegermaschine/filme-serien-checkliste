...
app.listen(port, () => {
  ...
  starteAufraeumen();
  // Loescht Rueckmeldungen nach Ablauf der in der Datenschutzerklaerung
  // (Abschnitt 10) zugesagten zwoelf Monate -- ohne diesen Lauf waere die
  // genannte Speicherdauer eine Zusage ohne Deckung.
