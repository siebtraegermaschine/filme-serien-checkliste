...
const RECHTECKE = {
  ...
  PT: [[36.8, -9.8, 42.3, -6.1],                // Festland
       [36.8, -31.4, 39.9, -24.9],              // Azoren
       [32.3, -17.5, 33.2, -16.2]],             // Madeira
  PL: [[48.9, 14.0, 55.1, 24.3]],
  DK: [[54.4, 8.0, 57.9, 15.3]],                // inkl. Bornholm
  SE: [[55.2, 10.9, 69.2, 24.3]],
  NO: [[57.8, 4.4, 71.3, 31.3]],
  FI: [[59.6, 19.3, 70.2, 31.7]],
  BE: [[49.4, 2.4, 51.6, 6.5]],
  IE: [[51.3, -10.7, 55.5, -5.9]],
  CZ: [[48.5, 12.0, 51.1, 18.9]],
  GR: [[34.7, 19.3, 41.8, 28.3]],               // inkl. Kreta und Inseln
  ...
  EE: [[57.5, 21.7, 59.7, 28.3]],               // inkl. Saaremaa/Hiiumaa
